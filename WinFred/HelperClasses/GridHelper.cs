...
namespace James.HelperClasses
{
    class GridHelper
    {
        ...
        public static string GetColumnDefinition(DependencyObject obj) => (string)obj.GetValue(ColumnDefinitionProperty);

        public static void SetColumnDefinition(DependencyObject obj, string value) => obj.SetValue(ColumnDefinitionProperty, value);
        ...
        public static void SetRowDefinition(DependencyObject obj, string value) => obj.SetValue(RowDefinitionProperty, value);
