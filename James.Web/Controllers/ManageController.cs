...
using James.Web.ViewModels.Manage;
...
namespace James.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ...
            {
                Username = await _userManager.GetUserNameAsync(GetCurrentUserAsync().Result),
        ...
        {
            if (await _context.ApplicationUser.CountAsync(user => user.UserName == username) != 0)
            {
            ...
            {
                ApplicationUser user = _userManager.FindByIdAsync(User.GetUserId()).Result;
