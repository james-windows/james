...
namespace Engine.Test.Splitter
{
    ...
    public class BasicDividerTest
    {
        ...
        public void DivideByUppercaseTest()
        {
            ...
            Assert.IsTrue(divider.SplitPath("aBBa").Count() == 3);
        ...
        public void DivideByAllCasesTest()
        {
            ...
            Assert.IsTrue(divider.SplitPath("VID_20160408_120150.mp4").Count() == 7);
            ...
            Assert.IsTrue(divider.SplitPath("TCPServer.zip").Count() == 6);
            ...
            Assert.IsTrue(divider.SplitPath("SirDrawALot").Count() == 4);
